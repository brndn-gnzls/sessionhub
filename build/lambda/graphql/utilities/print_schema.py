...
def print_implemented_interfaces(type_: GraphQLObjectType | GraphQLInterfaceType) -> str:
...
def print_description(
    def_: GraphQLArgument | GraphQLDirective | GraphQLEnumValue | GraphQLNamedType | GraphQLSchema,
    indentation: str = "",
