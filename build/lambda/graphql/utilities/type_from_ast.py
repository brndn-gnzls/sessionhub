...
@overload
def type_from_ast(schema: GraphQLSchema, type_node: NamedTypeNode) -> GraphQLNamedType | None: ...


@overload
def type_from_ast(schema: GraphQLSchema, type_node: ListTypeNode) -> GraphQLList | None: ...


@overload
def type_from_ast(schema: GraphQLSchema, type_node: NonNullTypeNode) -> GraphQLNonNull | None: ...
