...
def value_from_ast_untyped(value_node: ValueNode, variables: dict[str, Any] | None = None) -> Any:
...
def value_from_object(value_node: ObjectValueNode, variables: dict[str, Any] | None) -> Any:
    return {
...
def value_from_variable(value_node: VariableNode, variables: dict[str, Any] | None) -> Any:
