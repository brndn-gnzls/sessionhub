...
def lexicographic_sort_schema(schema: GraphQLSchema) -> GraphQLSchema:
    ...
    return GraphQLSchema(
        ...
        mutation=cast(GraphQLObjectType | None, replace_maybe_type(schema.mutation_type)),
        subscription=cast(GraphQLObjectType | None, replace_maybe_type(schema.subscription_type)),
        ast_node=schema.ast_node,
    )


def sort_by_name_key(type_: GraphQLNamedType | GraphQLDirective | DirectiveLocation) -> tuple:
