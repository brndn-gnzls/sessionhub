...
def extend_schema_impl(
    ...
    def build_input_object_type(
        ...
        extension_nodes = type_extensions_map[ast_node.name.value]
        all_nodes: list[InputObjectTypeDefinitionNode | InputObjectTypeExtensionNode] = [
            ast_node,
            *extension_nodes,
        ]
        return GraphQLInputObjectType(
...
def get_specified_by_url(node: ScalarTypeDefinitionNode | ScalarTypeExtensionNode) -> str | None:
