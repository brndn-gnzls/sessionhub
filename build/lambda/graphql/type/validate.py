...
class SchemaValidationContext:
    ...
    def validate_interfaces(self, type_: GraphQLObjectType | GraphQLInterfaceType) -> None:
...
def get_operation_type_node(schema: GraphQLSchema, operation: OperationType) -> Node | None:
