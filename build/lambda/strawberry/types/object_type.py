        ...
        if isinstance(field_, StrawberryField):
            ...
            if field_name not in cls_annotations:
                ...
                if field_.base_resolver.type_annotation is None:
                    raise MissingReturnAnnotationError(field_name, resolver=field_.base_resolver)
...
def _process_type(
    ...
    *,
    ...
    if is_input and interfaces:
        raise InvalidSuperclassInterfaceError(cls=cls, input_name=name, interfaces=interfaces)
