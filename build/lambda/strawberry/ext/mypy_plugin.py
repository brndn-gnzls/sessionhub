            ...
            if IS_PYDANTIC_V1:
                ...
                if PYDANTIC_VERSION:
                    ...
                    if PYDANTIC_VERSION >= (2, 9, 0):
                        extra["model_strict"] = model_type.type.metadata[PYDANTIC_METADATA_KEY][
                            "config"
                        ].get("strict", False)
...
class StrawberryPlugin(Plugin):
    ...
    def _is_strawberry_union(self, fullname: str) -> bool:
        return fullname == "strawberry.types.union.union" or fullname.endswith("strawberry.union")

    def _is_strawberry_enum(self, fullname: str) -> bool:
        return fullname == "strawberry.types.enum.enum" or fullname.endswith("strawberry.enum")
    ...
    def _is_strawberry_create_type(self, fullname: str) -> bool:
        ...
        return fullname == "strawberry.tools.create_type.create_type" or fullname.endswith(
            ".create_type"
        )
