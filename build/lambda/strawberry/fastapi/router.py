...
class GraphQLRouter(
    AsyncBaseHTTPView[Request, Response, Response, WebSocket, WebSocket, Context, RootValue],
    APIRouter,
):
    ...
    def __get_context_getter(
        custom_getter: Callable[..., CustomContext | None | Awaitable[CustomContext | None]],
    ...
    def __init__(
        ...
        context_getter: Callable[..., Context | None | Awaitable[Context | None]] | None = None,
        ...
        **kwargs: Any,
        ...
        @self.get(
            ...
            responses={
                ...
                404: {"description": ("Not found if GraphiQL or query via GET are not enabled.")},
            },
        ...
        async def handle_http_get(  # pyright: ignore
            ...
            try:
                return await self.run(request=request, context=context, root_value=root_value)
