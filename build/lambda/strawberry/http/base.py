...
class BaseView(Generic[Request]):
    ...
    def _is_multipart_subscriptions(self, content_type: str, params: dict[str, str]) -> bool:
    ...
    def _validate_batch_request(
        ...
        if protocol == "multipart-subscription":
            raise HTTPException(400, "Batching is not supported for multipart subscriptions")
