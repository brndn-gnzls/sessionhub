...
MergedContext = Union[BaseContext, WebSocketContextDict, HTTPContextDict, dict[str, Any]]
...
async def _context_getter_ws(custom_context: Any | None, socket: WebSocket) -> MergedContext:
