...
class StrawberryAnnotation:
    ...
    def _get_type_with_args(self, evaled_type: type[Any]) -> tuple[type[Any], list[Any]]:
    ...
    def create_maybe(self, evaled_type: Any) -> StrawberryMaybe:
        ...
        of_type = StrawberryAnnotation(annotation=inner_type, namespace=self.namespace).resolve()
    ...
    def _is_list(cls, annotation: Any) -> bool:
        ...
        return (annotation_origin in (list, tuple)) or annotation_origin is abc.Sequence or is_list
    ...
    def _is_strawberry_type(cls, evaled_type: Any) -> bool:
        ...
        if (
            ...
            or isinstance(evaled_type, StrawberryObjectDefinition)
            or isinstance(evaled_type, StrawberryOptional)
            or isinstance(evaled_type, ScalarDefinition)
            or isinstance(evaled_type, StrawberryUnion)
        ):
            return True
