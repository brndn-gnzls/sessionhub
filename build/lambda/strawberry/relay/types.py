...
class GlobalID:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.node_id, str):
            raise GlobalIDValueError(f"node_id is expected to be a string, found {self.node_id!r}")
...
class Connection(Generic[NodeType]):
    ...
    edges: list[Edge[NodeType]] = field(description="Contains the nodes in this connection")
