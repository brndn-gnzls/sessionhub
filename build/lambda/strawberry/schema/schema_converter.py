...
class CustomGraphQLEnumType(GraphQLEnumType):
    ...
    def parse_literal(self, value_node: ValueNode, _variables: dict[str, Any] | None = None) -> Any:
    ...
    *,
    ...
    if field.base_resolver:
        ...
        field_arguments.extend(
            [arg for arg in field.base_resolver.arguments if arg.python_name not in existing]
        )
...
class GraphQLCoreConverter:
    ...
    def from_enum(self, enum: EnumDefinition) -> CustomGraphQLEnumType:
        ...
        graphql_enum = CustomGraphQLEnumType(
            ...
            name=enum_name,
            values={
                self.config.name_converter.from_enum_value(enum, item): self.from_enum_value(item)
    ...
    def from_field(
        ...
        *,
        ...
        field_type = cast(
            "GraphQLOutputType",
            self.from_maybe_optional(field.resolve_type(type_definition=type_definition)),
        )
        subscribe = None
    ...
    def from_input_field(
        ...
        *,
        ...
        if (
            isinstance(field.type, StrawberryMaybe)
            or field.default_value is UNSET
            or field.default_value is dataclasses.MISSING
        ):
    ...
    def from_input_object(self, object_type: type) -> GraphQLInputObjectType:
        ...
        def check_one_of(value: dict[str, Any]) -> dict[str, Any]:
            ...
            if first_value is None or first_value is UNSET:
                raise GraphQLError(f"Value for member field '{first_key}' must be non-null")

            return value

        out_type = check_one_of if type_definition.is_input and type_definition.is_one_of else None
        ...
        def _get_is_type_of() -> Callable[[Any, GraphQLResolveInfo], bool] | None:
            ...
            def is_type_of(obj: Any, _info: GraphQLResolveInfo) -> bool:
                ...
                if object_type.concrete_of and (
                    ...
                    and obj.__strawberry_definition__.origin is object_type.concrete_of.origin
                ):
                    return True
    ...
    def from_resolver(self, field: StrawberryField) -> Callable:  # TODO: Take StrawberryResolver
        ...
        async def _async_resolver(_source: Any, info: GraphQLResolveInfo, **kwargs: Any) -> Any:
            strawberry_info = _strawberry_info_from_graphql(info)
    ...
    def from_type(self, type_: StrawberryType | type) -> GraphQLNullableType:
        ...
        if compat.is_scalar(type_, self.scalar_registry):  # TODO: Replace with StrawberryScalar
    ...
    def is_same_type_definition(
        ...
        for type_var, type1 in first_type_definition.type_var_map.items():
            ...
            if not same_type and has_object_definition(type1) and has_object_definition(type2):
