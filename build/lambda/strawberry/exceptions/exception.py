...
class StrawberryException(Exception, ABC):
    ...
    def _get_error_inline(self, exception_source: ExceptionSource, message: str) -> RenderableType:
        ...
        caret = "^" * (exception_source.error_column_end - exception_source.error_column)
