...
class Schema(BaseSchema):
    ...
    def _get_federation_query_type(
        ...
        if entity_type:
            ...
            entities_field = strawberry.field(name="_entities", resolver=self.entities_resolver)
    ...
    def _add_link_directives(self, additional_directives: list[object] | None = None) -> None:
