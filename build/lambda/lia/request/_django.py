...
class DjangoHTTPRequestAdapter(SyncHTTPRequestAdapter):
    ...
    def body(self) -> str | bytes:
        return cast(str | bytes, self.request.body.decode())
    ...
    def post_data(self) -> Mapping[str, str | bytes]:
        return cast(Mapping[str, str | bytes], self.request.POST)
    ...
    def get_form_data(self) -> FormData:
        return FormData(
            ...
            form=cast(Mapping[str, str | bytes], self.request.POST),
        )

    @property
    def content_type(self) -> str | None:
        return cast(str | None, self.request.content_type)
