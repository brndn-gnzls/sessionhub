...
class JsonFormatter(logging.Formatter):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.reserved_attrs = dict(zip(reserved_attrs, reserved_attrs, strict=False))
        ...
        self._skip_fields = dict(zip(self._required_fields, self._required_fields, strict=False))
    ...
    def add_fields(
        ...
        merge_record_extra(
            record, log_record, reserved=self._skip_fields, rename_fields=self.rename_fields
        )
